          ...
          <div className="row">
            <div className="col-5">
              <h2 className="h2 text-center earn-h2">
                ...
                <span className="earn-span">US$100</span> of $TRAVELERSE
                invested,
              </h2>
            </div>
            ...
            <div className="col-5">
              <h2 className="h2 text-center earn-h2">
                you can earn up to
                <span className="earn-span">US$213,139.27</span> of $TRAVELERSE
                at
                <span className="earn-span">213,139.27%</span> APY*.
              </h2>
            </div>
          </div>
