...
import { FaUserLock, FaPiggyBank, FaTelegram } from "react-icons/fa";
  ...
  return (
    <>
      <section className="container-fluid py-5">
        <h1 className="h1 work-h1 fw-bold text-center">HOW IT WORKS</h1>
        <h3 className="h3 text-center fw-bolder">
